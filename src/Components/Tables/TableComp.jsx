                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="stakingTable_body_row_data">
                          ...
                          {metaData.symbol === "USD" ? "USDT" : null}{" "}
                          {metaData.symbol === "EGC" ? "EGC" : null}{" "}
                          {metaData.symbol === "EGAX" ? "EGAX" : null}{" "}
                          {metaData.tokenOut === "USDT" ? "USDT" : null}{" "}
                          {metaData.tokenOut === "EGC" ? "EGC" : null}{" "}
                          {metaData.tokenOut === "EGAX" ? "EGAX" : null}{" "}
                          {metaData.tokenOut === "NGN" ? "₦" : null}{" "}
                        </td>
                        ...
                        <td className="stakingTable_body_row_data stakingTable_body_row_data_last">
                          <div className="stakingTable_body_row_data_last_div">
                            {data.status === "SUCCESS" ? (
                              ...
                              <div className="stakingTable_body_row_status_error">
                                {data.status}
                              </div>
                            ) : (
                              <>{data.status}</>
...
export const Table = ({
  ...
  return (
    <div className="TableCompWithDiv">
      <div className="TableCompWithDiv_title">
        {tableTitle}{" "}
        <Link to="#" className="TableCompWithDiv_title_link">
          <button className="TableCompWithDiv_title_btn">View All</button>
        </Link>
      </div>
      <div className="TableCompWithDiv_cont">
              ...
              <table className="TableCompWithDiv_cont_table">
                ...
                <tbody className="stakingTable_body">
                  {updatedTableData.map((data) => {
                    ...
                    //// console.logog(formattedTime);
                    return (
                      <tr className="stakingTable_body_row " id={data.id}>
                        {metaData.to_username === userName &&
                        data.type === "INTERNAL" ? (
                          <td
                            className="stakingTable_body_row_data stakingTable_body_row_data_first "
                            id={data.id}
                            onClick={() => {
                              ToggleSaleDetails(data.id);
                            }}
                        ...
                        <td
                          className="stakingTable_body_row_data"
                          id={data.id}
                          onClick={() => {
                            ToggleSaleDetails(data.id);
                          }}
                        ...
                        {/* {data.type === "Credit" ? (
                          ...
                          >
                            <div className="stakingTable_body_row_email">
                              {metaData.symbol === "EGAX" ? (
                                <a
                                  style={{ color: "white" }}
                                  href={"https://egoscan.io/tx/" + metaData.txh}
                                >
                                  Explore Txn
                                </a>
                              ) : metaData.symbol === "USD" &&
                                ...
                                <a
                                  style={{ color: "white" }}
                                  href={
                                    "https://bscscan.com/tx/" + metaData.txh
                                  }
                                >
                                  Explore Txn
                                </a>
                              ) : metaData.symbol === "ESTA" &&
                                metaData.network === "Egochain" ? (
                                <a
                                  style={{ color: "white" }}
                                  href={"https://egoscan.io/tx/" + metaData.txh}
                                >
                                ...
                                metaData.network === "Ethereum (ERC20)" ? (
                                <a
                                  style={{ color: "white" }}
                                  href={
                                    "https://etherscan.io/tx/" + metaData.txh
                                  }
                                >
                                  Explore Txn
                                </a>
                        ...
                        <td
                          className="stakingTable_body_row_data stakingTable_body_row_data_last"
                          id={data.id}
                          onClick={() => {
                            ToggleSaleDetails(data.id);
                          }}
